...
def log_to_s3(submission_data):
    ...
    try:
        ...
        if not file_exists or not existing_content:
            csv_content = "timestamp,submission_id,alias,claimed_sev,actual_sev,sim_ticket_sev,station,coupa_link,sim_link,sim_ticket_id,need_by_date,description,first_approver,second_approver,false_escalation,mismatch_reason,has_sim_ticket,repeat_count,source\n"
        else:
